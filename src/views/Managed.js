                ...
                <div className="activities-container">
                    ...
                    <div className="profile-stats-card">
                        <div className="profile-stats-card-header">
                            ...
                            <div className="icon-container">
                                <button className="arrow-button" onClick={() => this.setState({ pendingExpand: !this.state.pendingExpand })}>
                                    <img className="arrow-icon" style={{  transform: this.state.pendingExpand ? 'rotate(180deg)' : 'rotate(0deg)' }} src="../../images/chevron.svg" alt="close-cross"></img>
                                </button>
                            </div>
                        </div>
